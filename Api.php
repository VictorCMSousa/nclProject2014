...
function SetVotes($id_jog_entra, $id_jog_sai, $time)
{
	...
	_FetchJogadores(mysqli_query($con,"SELECT jog.nome as 'nome_entra', jog.time as 'time_entra', jog.camisa as 'camisa_entra',jog2.nome as 'nome_sai', 
jog2.time as 'time_sai', jog2.camisa as 'camisa_sai',Count(sub.id) soma 
